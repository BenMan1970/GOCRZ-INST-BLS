# ==========================================
# BLUESTAR SCANNER V6.4 - ARCHITECTURE PYRAMIDE
...
class SignalQuality:
    ...
    def calculate_tier2_premium(df_m5, df_m15, df_d, df_w, symbol, direction, atr, cs_scores):
        ...
        if ob_valid:
            ...
            # PAS DE REJET - juste pas de bonus
...
def display_sig_v640(s):
    ...
    if "ELITE" in d['quality']:
        quality_badge = "<span class='badge' style='background:#FFD700;color:black;font-size:1em;'>🏆 ELITE</span>"
    elif "PREMIUM" in d['quality']:
        quality_badge = "<span class='badge' style='background:#C0C0C0;color:black;font-size:1em;'>⭐ PREMIUM</span>"
    else:
        quality_badge = "<span class='badge badge-blue' style='font-size:1em;'>✅ STANDARD</span>"
...
def main():
    ...
    if st.button("🔍 SCANNER V6.4"):
        with st.spinner("Analyse Pyramide..."):
            api = OandaClient()
        ...
        if not results:
            ...
            with st.expander("📊 Statistiques"):
                ...
                st.write(f"🏆 Elite: {elite} | ⭐ Premium: {premium} | ✅ Standard: {standard}")
